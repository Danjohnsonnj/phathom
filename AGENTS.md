...
| 4 | **Active hand-offs** | [`phase-3-rag-chat.md`](docs/handoff/phase-3-rag-chat.md) · [`library-ui-evolution.md`](docs/handoff/library-ui-evolution.md) (discovery locked) · [`ui-evolution-token-sheet.md`](docs/handoff/ui-evolution-token-sheet.md) · **implementation plan TBD** |

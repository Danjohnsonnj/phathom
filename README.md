...
| **App UI evolution** (design discovery — Library · Detail · Add New locked; HTML → SwiftUI) | [`docs/handoff/library-ui-evolution.md`](docs/handoff/library-ui-evolution.md) |

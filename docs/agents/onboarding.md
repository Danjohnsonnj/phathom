...
| Product state / what shipped | [`docs/agents/product-state.md`](product-state.md) |
| Focus Stack — follow-ups / delivery | [`docs/handoff/focus-stack-delivery.md`](../handoff/focus-stack-delivery.md) (**opt-in**) |
...
| Pipeline | [`docs/concepts/inference/index.md`](../concepts/inference/index.md) → [`BackgroundPipeline.swift`](../../Phathom/Phathom/Services/BackgroundPipeline.swift) |
| Inference | [`docs/concepts/inference/index.md`](../concepts/inference/index.md) → [`SharedLlamaInference.swift`](../../Phathom/Phathom/Services/SharedLlamaInference.swift) |
...
Pipeline + ingest **shipped**. **Focus Stack v1 shipped** (Phases A + B + **A+**). See [`product-state.md`](product-state.md). **Phase C** (Connect / Thread) **not started** — opt-in [`focus-stack-delivery.md`](../handoff/focus-stack-delivery.md). **RAG / Chat deferred** — no Chat tab. **Session wrap-up:** update [`product-state.md`](product-state.md) + delivery log when applicable.
